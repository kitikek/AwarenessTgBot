            ...
            async Task HandleUpdateAsync(ITelegramBotClient botClient, Update receivedUpdate, CancellationToken cancellationToken)
            {
                ...
                if (message.Text is "/start")
                {
                    ...
                    Message sentMessage = await botClient.SendTextMessageAsync(
                        ...
                        "Если Вы хотите пройти тест заново, то напишите **«Начать тест»** в сообщении!",
                ...
                if (message.Text is "/help")
                {
                    ...
                    Message sentMessage = await botClient.SendTextMessageAsync(
                        chatId, "Если у вас возникли технические проблемы или ошибки при работе" +
                        " с Телеграм-ботом «Мы вместе», то для получения помощи обратитесь в службу технической поддержки: " +
                        "\nsupp0rtmindfulless@yandex.ru"
                        );
                }
                ...
                if (message.Text is "Книги")
                {
                    ...
                    ReplyKeyboardMarkup replyKeyboardMarkup = new(new[] { new KeyboardButton[] { "Век тревожности. Скотт Стоссел" },
                        new KeyboardButton[]{"Внутреннее спокойствие. Таня Петерсон"},
                        new KeyboardButton[] { "Управление тревогой. Катлин Смит" },
                        new KeyboardButton[] { "Тревожность. Эдмунд Борн, Лорна Гарано" },
                        new KeyboardButton[]{ "Терапия беспокойства. Дэвид Бернс" },
                        new KeyboardButton[] { "Тревожный мозг. Джозеф А. Аннибали" },
                        new KeyboardButton[] { "Свобода от тревоги. Роберт Лихи" },
                        new KeyboardButton[]{ "Беспокойный человек. Стюарт Геддес" },
                        new KeyboardButton[] { "Я с тобой. Гед Дженкинс-Омар" },
                        new KeyboardButton[]{ "Будь спок. Джилл Уэбер" }})
                    {
                        ResizeKeyboard = true
                    };
                    Message sentMessage = await botClient.SendTextMessageAsync(
                ...
                if (message.Text is "Век тревожности. Скотт Стоссел")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Внутреннее спокойствие. Таня Петерсон")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Управление тревогой. Катлин Смит")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Тревожность. Эдмунд Борн, Лорна Гарано")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Терапия беспокойства. Дэвид Бернс")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Тревожный мозг. Джозеф А. Аннибали")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Свобода от тревоги. Роберт Лихи")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Беспокойный человек. Стюарт Геддес")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Я с тобой. Гед Дженкинс-Омар")
                {
                    var chatId = message.Chat.Id;
                ...
                if (message.Text is "Будь спок. Джилл Уэбер")
                {
                    var chatId = message.Chat.Id;
